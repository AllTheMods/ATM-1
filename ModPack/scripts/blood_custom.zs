...
recipes.addShapeless(
	<akashictome:tome>.withTag({"akashictome:is_morphing": 1 as byte, "akashictome:data": {tconstruct: {id: "tconstruct:book", Count: 1 as byte, tag: {"akashictome:displayName": "Materials and You", "akashictome:definedMod": "tconstruct", "akashictome:is_morphing": 1 as byte, display: {Name: "§rAkashic Tome (§aMaterials and You§r)"}, mantle: {book: {page: ""}}}, Damage: 0 as short}, astralsorcery: {id: "astralsorcery:ItemJournal", Count: 1 as byte, tag: {"akashictome:displayName": "Journal", "akashictome:definedMod": "astralsorcery", "akashictome:is_morphing": 1 as byte, display: {Name: "§rAkashic Tome (§aJournal§r)"}}, Damage: 0 as short}, theoneprobe: {id: "theoneprobe:probenote", Count: 1 as byte, tag: {"akashictome:definedMod": "theoneprobe"}, Damage: 0 as short}, immersiveengineering: {id: "immersiveengineering:tool", Count: 1 as byte, tag: {"akashictome:definedMod": "immersiveengineering"}, Damage: 3 as short}, rftools: {id: "rftoolsdim:rftoolsdim_manual", Count: 1 as byte, tag: {"akashictome:definedMod": "rftools"}, Damage: 0 as short}, guideapi1: {id: "guideapi:ItemGuideBook", Count: 1 as byte, tag: {"akashictome:definedMod": "guideapi1"}, Damage: 4 as short}, botania: {id: "botania:lexicon", Count: 1 as byte, tag: {"knowledge.minecraft": 1 as byte, "akashictome:definedMod": "botania", "knowledge.alfheim": 1 as byte, "knowledge.relic": 1 as byte}, Damage: 0 as short}, bloodmagic1: {id: "bloodmagic:ItemSanguineBook", Count: 1 as byte, tag: {"akashictome:definedMod": "bloodmagic1"}, Damage: 0 as short}, draconicevolution: {id: "draconicevolution:info_tablet", Count: 1 as byte, tag: {"akashictome:definedMod": "draconicevolution"}, Damage: 0 as short}, extrautils2: {id: "extrautils2:book", Count: 1 as byte, tag: {"akashictome:definedMod": "extrautils2"}, Damage: 0 as short}, guideapi2: {id: "guideapi:ItemGuideBook", Count: 1 as byte, tag: {"akashictome:definedMod": "guideapi2"}, Damage: 1 as short}, guideapi3: {id: "guideapi:ItemGuideBook", Count: 1 as byte, tag: {"akashictome:definedMod": "guideapi3"}, Damage: 0 as short}, actuallyadditions: {id: "actuallyadditions:itemBooklet", Count: 1 as byte, tag: {"akashictome:definedMod": "actuallyadditions"}, Damage: 0 as short}, opencomputers: {id: "opencomputers:tool", Count: 1 as byte, tag: {"akashictome:definedMod": "opencomputers"}, Damage: 4 as short}, abyssalcraft: {id: "abyssalcraft:necronomicon", Count: 1 as byte, tag: {"akashictome:definedMod": "abyssalcraft", PotEnergy: 0.0 as float}, Damage: 0 as short}, xnet: {id: "xnet:xnet_manual", Count: 1 as byte, tag: {"akashictome:definedMod": "xnet"}, Damage: 0 as short}, rftoolscontrol: {id: "rftoolscontrol:rftoolscontrol_manual", Count: 1 as byte, tag: {"akashictome:definedMod": "rftoolscontrol"}, Damage: 0 as short}, extrautils21: {id: "extrautils2:powermanager", Count: 1 as byte, tag: {"akashictome:definedMod": "extrautils21"}, Damage: 0 as short}, roots: {id: "roots:runedTablet", Count: 1 as byte, tag: {"akashictome:definedMod": "roots"}, Damage: 0 as short}, environmentaltech: {id: "environmentaltech:digital_guide", Count: 1 as byte, tag: {"akashictome:displayName": "Digital Guide [WIP]", "akashictome:definedMod": "environmentaltech", "akashictome:is_morphing": 1 as byte, display: {Name: "§rAkashic Tome (§aDigital Guide [WIP]§r)"}}, Damage: 0 as short}, rftools1: {id: "rftools:rftools_manual", Count: 1 as byte, tag: {"akashictome:definedMod": "rftools1"}, Damage: 0 as short}, guideapi: {id: "guideapi:ItemGuideBook", Count: 1 as byte, tag: {"akashictome:definedMod": "guideapi"}, Damage: 2 as short}, spiceoflife: {id: "spiceoflife:bookfoodjournal", Count: 1 as byte, tag: {"akashictome:definedMod": "spiceoflife"}, Damage: 0 as short}, practicallogistics2: {id: "practicallogistics2:PLGuide", Count: 1 as byte, tag: {"akashictome:definedMod": "practicallogistics2"}, Damage: 0 as short}, bloodmagic: {id: "bloodmagic:ItemSanguineBook", Count: 1 as byte, tag: {"akashictome:definedMod": "bloodmagic"}, Damage: 0 as short}}})
